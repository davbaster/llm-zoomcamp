...
class RAGBase:
    ...
    # The other four parameters all have defaults. You only pass course, instructions, prompt_template, or model when you want to override the default behavior. We swap the index later without touching any of the RAG code.
